...
const inquilinoSelectedLabel = (inquilino: any) => `${inquilino.nombre || `Inquilino #${inquilino.id_inquilino}`} — CI ${inquilino.ci || "sin CI"}`;
