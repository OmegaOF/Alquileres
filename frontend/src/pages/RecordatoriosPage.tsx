...
export default function RecordatoriosPage() {
  ...
  const sinRespuesta = items.filter((x) => x.estado_recordatorio === "sin_respuesta");
  ...
  const rows = items.map((x) => ({ ...x, estado_recordatorio_legible: formatRecordatorio(x.estado_recordatorio || "no_preparado") }));
